...
<span id="extra"> Részletes leírását találod a technológiának <a href="/it/mozi">a mi mozink</a> című írásban.</span>\
<details>\
...
async function mozi_modul() {
  ...
  const anyag = await fetch("/mozi-modul");
  ...
  */
  ...
  mozi_helye.innerHTML += mozi_modul_html;
  keret = document.getElementById(mozi_keret);
  var kopasz = keret.hasAttribute("kopasz");
  if (!kopasz) mozi_helye.innerHTML += mozi_modul_txt;
}
